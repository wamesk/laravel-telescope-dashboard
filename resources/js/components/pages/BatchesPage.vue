<template>
    <div>
        ...
        <DataTable
            ...
            @retry="search"
        >
            <template #cell-content.failed_jobs="{ value }">
                <span :class="value > 0 ? 'text-red-400' : ''">{{ value }}</span>
            </template>
...
const columns = [
    ...
    { key: 'content.pending_jobs', label: 'Pending', width: '100px' },
    { key: 'content.failed_jobs', label: 'Failed', width: '100px' },
